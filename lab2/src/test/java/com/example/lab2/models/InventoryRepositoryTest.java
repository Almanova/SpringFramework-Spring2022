...
public class InventoryRepositoryTest {
    ...
    public void findAvailableTest() {
        ...
        assertThat(inventoryRepo.findAvailablePlants("Mini", LocalDate.of(2017,2,20),
                LocalDate.of(2017,2,25))).contains(entry);
        ...
        assertThat(inventoryRepo.findAvailablePlants("Mini", LocalDate.of(2017,2,20),
                LocalDate.of(2017,2,25))).doesNotContain(entry);
    }
}
